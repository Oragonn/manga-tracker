...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('btn-add-cancel')?.addEventListener('click', () => addModal.classList.add('hidden'));
  document.getElementById('btn-edit-cancel')?.addEventListener('click', () => editModal.classList.add('hidden'));
